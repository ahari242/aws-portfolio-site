/*
 Copyright (c) 2017, Adam Hari. All rights reserved.
...
$(window).load(function() {
    ...
    blurRadius = "10px", // Change blur radius for animation here
    paraSplit, headSplit,
    ...
    function initAnimation() {
        ...
        if($paragraph.length) {
            ...
            $.each(paraSplit.chars, function(index, el) {
                ...
                var tweenPos = "end+=" + (index) * 0.03; //change value to alter how fast the letters reveal
